<template>
    <div class="h-full bg-gray-100 rounded-r-md p-2 customScroll overflow-y-auto">
        ...
        <main>
            <div class="flex flex-col px-3 justify-center items-center mt-4">
                ...
                <form @submit.prevent="updateUserInfo" class="w-full  mt-2">
                    <div class="flex flex-col items-start py-5 px-2 rounded-md justify-between w-full">
                        ...
                        <span class="text-sm mb-1 block text-gray-400 font-semibold">Your name</span>
                        ...
                        <div v-if="editName" class="flex w-full items-center justify-between">
                            ...
                            <button type="button" @click="doneEditingName" class="flex text-gray-400 hover:text-gray-600 flex-col items-center justify-center p-2 ml-2 rounded-full focus:ring-2 hover:bg-gray-300 hover:bg-opacity-30 focus:outline-none" aria-label="Add">
                    ...
                    <!-- Change Email -->
                    <div class="flex flex-col items-start pb-5 mt-1 px-2 rounded-md justify-between w-full">
                        ...
                        <div v-if="editEmail" class="flex w-full items-center justify-between">
                            ...
                            <button type="button" @click="doneEditingEmail" class="flex text-gray-400 hover:text-gray-600 flex-col items-center justify-center p-2 ml-2 rounded-full focus:ring-2 hover:bg-gray-300 hover:bg-opacity-30 focus:outline-none" aria-label="Add">
                                <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
                                    <path d="M15.898,4.045c-0.271-0.272-0.713-0.272-0.986,0l-4.71,4.711L5.493,4.045c-0.272-0.272-0.714-0.272-0.986,0s-0.272,0.714,0,0.986l4.709,4.711l-4.71,4.711c-0.272,0.271-0.272,0.713,0,0.986c0.136,0.136,0.314,0.203,0.492,0.203c0.179,0,0.357-0.067,0.493-0.203l4.711-4.711l4.71,4.711c0.137,0.136,0.314,0.203,0.494,0.203c0.178,0,0.355-0.067,0.492-0.203c0.273-0.273,0.273-0.715,0-0.986l-4.711-4.711l4.711-4.711C16.172,4.759,16.172,4.317,15.898,4.045z"></path>
                                </svg>
                            </button>
...
<!--                Change Password-->
                <form @submit.prevent="updatePassword" class="w-full px-2 pt-5 border-b border-gray-300">
                ...
                <form method="POST" @submit.prevent="logout" class="w-full pt-5">
                    <button type="submit" class="flex w-full items-center justify-center py-2 mr-2 text-sm text-white bg-gray-400 rounded-md focus:outline-none hover:bg-gray-500 hover:shadow-lg">
