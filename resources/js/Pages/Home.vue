    ...
    <div class="h-screen">
        <section class="flex w-full overflow-hidden rounded-md shadow-xl lg:mx-auto">
            ...
            <div class="relative w-2/6">
                <left-section :contacts="contacts" :changeCurrentRightSide="changeCurrentRightSide" :switchToTeam="switchToTeam" />
            ...
            <div class="flex w-full h-full bg-gray-100">
                ...
                >
                    ...
                    <div
                        ...
                        class="w-full h-full">
                        <right-section :pendingGroupInvites="pendingGroupInvites" :findUsers="findUsers" :rightSideComponent="rightSideComponent" :changeCurrentLeftSide="changeCurrentLeftSide" />
                    </div>
                </div>
    ...
    methods: {
        ...
        switchToTeam(team) {
            if (!team.isFriend) {
                ...
                this.$inertia.put(route('switch.conversations'), {
                    'pm_id': team.teamId
                },{
                    preserveState: false
                });
